...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:mdb="http://standards.iso.org/19115/-3/mdb/1.0"
  ...
  <!--<xsl:variable name="templateXml"
                select="document('file:/C:/sources/template-etl-merge/templateWithOriginator.xml')"/>-->
  ...
  <xsl:template match="mdb:MD_Metadata">
    <xsl:copy>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:distributionFormat or
                ...
                <xsl:choose>
                  <xsl:when test="mrd:MD_Distribution">
                    <xsl:for-each select="mdb:MD_Distribution">
                      ...
                      <xsl:choose>
                        <xsl:when
                                test="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:distributionFormat">
                          <xsl:copy-of
                                  select="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:distributionFormat"
                                  />
                        </xsl:when>
                        <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when
                                test="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:distributor">
                          <xsl:copy-of
                                  select="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:distributor"
                                  />
                        </xsl:when>
                        <xsl:otherwise>
                      ...
                      <xsl:choose>
                        <xsl:when
                                test="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:transferOptions">
                          <xsl:copy-of
                                  select="$templateXml/mdb:MD_Metadata/mdb:distributionInfo/mrd:MD_Distribution/mrd:transferOptions"
                                  />
                        </xsl:when>
                        <xsl:otherwise>
  ...
  <xsl:template match="mri:MD_DataIdentification">
    <xsl:copy>
        ...
        <xsl:copy>
          ...
          <xsl:for-each select="cit:CI_Citation">
            <xsl:copy>
              ...
              <xsl:choose>
                <xsl:when
                        test="string($templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:title/gco:CharacterString)">
                  <xsl:copy-of
                          select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:title"
                          />
                </xsl:when>
                <xsl:otherwise>
              ...
              <xsl:choose>
                <xsl:when
                        test="count($templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:date/cit:CI_Date[cit:dateType/cit:CI_DateTypeCode/@codeListValue='publication']/cit:date[normalize-space(*) != '']) > 0">
                  <xsl:copy-of
                          select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:date[cit:CI_Date/cit:dateType/cit:CI_DateTypeCode/@codeListValue='publication']"
                          />
                </xsl:when>
                <xsl:otherwise>
                  <xsl:apply-templates
                          select="cit:date[cit:CI_Date/cit:dateType/cit:CI_DateTypeCode/@codeListValue='publication']"
                          />
                </xsl:otherwise>
              </xsl:choose>
              ...
              <xsl:apply-templates
                      select="cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue != 'originator' and
              ...
              <xsl:choose>
                <xsl:when
                        test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue = 'originator']">
                  <xsl:copy-of
                          select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue = 'originator']"
                          />
                </xsl:when>
                <xsl:otherwise>
                  <xsl:apply-templates
                          select="cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue = 'originator']"
                          />
                </xsl:otherwise>
              </xsl:choose>
              ...
              <xsl:choose>
                <xsl:when
                        test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue = 'publisher']">
                  <xsl:copy-of
                          select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:citedResponsibleParty[cit:CI_Responsibility/cit:role/cit:CI_RoleCode/@codeListValue = 'publisher']"
                          />
                </xsl:when>
                <xsl:otherwise>
                  <xsl:apply-templates
              ...
              <xsl:choose>
                <xsl:when
                        test="count($templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:presentationForm[normalize-space(cit:CI_PresentationFormCode/@codeListValue) != '']) > 0">
                  <xsl:copy-of
                          select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:citation/cit:CI_Citation/cit:presentationForm"
                          />
                </xsl:when>
                <xsl:otherwise>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:spatialRepresentationType">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:spatialRepresentationType"
                  />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:spatialResolution">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:spatialResolution"
                  />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:choose>
        <xsl:when
                test="count($templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:topicCategory[normalize-space(mri:MD_TopicCategoryCode) != '']) > 0">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:topicCategory"
                  />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:apply-templates
              select="mri:extent[not(gex:EX_Extent/gex:geographicElement) and not(gex:EX_Extent/gex:temporalElement)]"/>

      <!-- Temporal extent from the template -->
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:extent[gex:EX_Extent/gex:temporalElement]">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:extent[gex:EX_Extent/gex:temporalElement]"
                  />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:extent[gex:EX_Extent/gex:geographicElement]">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:extent[gex:EX_Extent/gex:geographicElement]"
                  />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:apply-templates
              select="mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue != 'theme' and
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'theme']">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'theme']"
                  />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates
                  select="mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'theme']"
                  />
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'place']">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'place']"
                  />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates
                  select="mri:descriptiveKeywords[mri:MD_Keywords/mri:type/mri:MD_KeywordTypeCode/@codeListValue = 'place']"
                  />
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:resourceConstraints/mco:MD_LegalConstraints/mco:accessConstraints or
          ...
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:resourceConstraints[mco:MD_LegalConstraint]"/>
      ...
      <xsl:choose>
        <xsl:when
                test="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:defaultLocale">
          <xsl:copy-of
                  select="$templateXml/mdb:MD_Metadata/mdb:identificationInfo/mri:MD_DataIdentification/mri:defaultLocale"
                  />
        </xsl:when>
        <xsl:otherwise>
