        ...
        <xsl:when
          ...
          <mdb:resourceLineage>
            ...
            <mrl:source uuidref="{$sourceUuid}"
                        xlink:href="{$siteUrl}/csw?service=CSW&amp;request=GetRecordById&amp;version=2.0.2&amp;outputSchema=http://standards.iso.org/19115/-3/gmd&amp;elementSetName=full&amp;id={$sourceUuid}"/>
