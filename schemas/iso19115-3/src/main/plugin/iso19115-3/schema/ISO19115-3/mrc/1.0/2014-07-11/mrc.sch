...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <sch:ns prefix="mrc" uri="http://www.isotc211.org/namespace/mrc/1.0/2013-06-24"/>
  ...
  <sch:pattern id="conf.resource-content-xml.schematron-rules">
    ...
    <sch:rule context="//mrc:MD_FeatureCatalogue">
      <sch:assert test="contains(/*/@xsi:schemaLocation,'http://www.isotc211.org/namespace/gfc')">The Feature Catalog schema location must be defined for the MD_FeatureCatalog.</sch:assert>
    </sch:rule>
