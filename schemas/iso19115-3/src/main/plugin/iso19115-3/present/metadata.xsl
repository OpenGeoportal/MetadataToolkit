...
<xsl:stylesheet version="2.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="metadata-subtemplates.xsl"/>
	...
	<!-- main template - the way into processing iso19115-3 -->
	...
	<!-- ============================================================================= -->
	<!-- iso19115-3 complete tab template	-->
	<!-- ============================================================================= -->
	...
	<xsl:template name="iso19115-3CompleteTab">
		...
		<xsl:if test="/root/gui/config/metadata-tab/advanced">
			...
			<xsl:call-template name="displayTab">
				...
				<xsl:with-param name="text"    select="/root/gui/schemas/iso19115-3/strings/resourceLineageTab"/>
				<xsl:with-param name="indent"  select="'&#xA0;&#xA0;&#xA0;'"/>
				<xsl:with-param name="tabLink" select="$tabLink"/>
			</xsl:call-template>
