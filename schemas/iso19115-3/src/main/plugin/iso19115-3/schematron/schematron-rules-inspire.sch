...
-->
    ...
    <sch:ns prefix="dqm" uri="http://standards.iso.org/19157/-2/dqm/1.0/2014-12-25"/>
    <sch:ns prefix="cit" uri="http://standards.iso.org/19115/-3/cit/1.0/2014-12-25"/>
    <sch:ns prefix="gco" uri="http://standards.iso.org/19115/-3/gco"/>
	...
	<sch:pattern>
		...
		-->
		<sch:rule context="//mdb:distributionInfo/*/mrd:transferOptions/*/mrd:onLine/gmd:CI_OnlineResource">
	...
	<sch:pattern>
		...
		<sch:rule context="//mri:MD_DataIdentification|
		  ...
		  <sch:let name="inspire-thesaurus" value="document(concat('file:///', $thesaurusDir, '/external/thesauri/theme/inspire-theme.rdf'))"/>
			...
			<sch:let name="thesaurus_name" value="gmd:descriptiveKeywords/*/gmd:thesaurusName/*/cit:title/*/text()"/>
	...
	<sch:pattern>
		...
		<sch:rule context="//gmd:DQ_DataQuality[../../mdb:identificationInfo/mri:MD_DataIdentification
			or ../../mdb:identificationInfo/*/@gco:isoType = 'mri:MD_DataIdentification']">
		...
		<sch:rule context="//mri:MD_DataIdentification/gmd:spatialResolution|//*[@gco:isoType='mri:MD_DataIdentification']/gmd:spatialResolution">
			<sch:assert
	...
	<sch:pattern>
		...
		<sch:rule context="//gmd:dataQualityInfo/*/gmd:report/*/gmd:result/*">
			...
			<sch:let name="specification_title" value="gmd:specification/*/cit:title/*/text()"/>
	...
	<sch:pattern>
		...
		<sch:rule context="//mri:MD_DataIdentification/gmd:resourceConstraints/*|
			//*[@gco:isoType='mri:MD_DataIdentification']/gmd:resourceConstraints/*|
	...
	<sch:pattern>
		...
		<sch:rule context="//mdb:identificationInfo/*/gmd:pointOfContact
			|//*[@gco:isoType='mri:MD_DataIdentification']/gmd:pointOfContact
