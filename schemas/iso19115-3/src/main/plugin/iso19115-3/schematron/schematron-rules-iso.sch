...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.cit.individualnameandposition-failure-en" xml:lang="en">The individual does not have a name or a position.</sch:diagnostic>
      <sch:diagnostic id="rule.cit.individualnameandposition-failure-fr" xml:lang="fr">Une personne n'a pas de nom ou de fonction.</sch:diagnostic>
    
      <sch:diagnostic id="rule.cit.individualnameandposition-success-en" xml:lang="en">Individual name is  
      "<sch:value-of select="normalize-space($name)"/>"
      and position
      "<sch:value-of select="normalize-space($position)"/>"
      .</sch:diagnostic>
      <sch:diagnostic id="rule.cit.individualnameandposition-success-fr" xml:lang="fr">Le nom de la personne est  
      "<sch:value-of select="normalize-space($name)"/>"
      ,sa fonction 
      "<sch:value-of select="normalize-space($position)"/>"
      .</sch:diagnostic>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.cit.organisationnameandlogo-failure-en" xml:lang="en">The organisation does not have a name or a logo.</sch:diagnostic>
      <sch:diagnostic id="rule.cit.organisationnameandlogo-failure-fr" xml:lang="fr">Une organisation n'a pas de nom ou de logo.</sch:diagnostic>
    
      <sch:diagnostic id="rule.cit.organisationnameandlogo-success-en" xml:lang="en">Organisation name is  
      "<sch:value-of select="normalize-space($name)"/>"
      and logo filename is 
      "<sch:value-of select="normalize-space($logo)"/>"
      .</sch:diagnostic>
      <sch:diagnostic id="rule.cit.organisationnameandlogo-success-fr" xml:lang="fr">Le nom de l'organisation est  
      "<sch:value-of select="normalize-space($name)"/>"
      , son logo
      "<sch:value-of select="normalize-space($logo)"/>"
      .</sch:diagnostic>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.gex.extenthasoneelement-failure-en" xml:lang="en">The extent does not contains any element.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-failure-fr" xml:lang="fr">L'étendue ne contient aucun élement.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-desc-success-en" xml:lang="en">The extent contains e description.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-desc-success-fr" xml:lang="fr">L'étendue contient une description.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-id-success-en" xml:lang="en">The extent contains a geographic identifier.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-id-success-fr" xml:lang="fr">L'étendue contient un identifiant géographique.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-box-success-en" xml:lang="en">The extent contains a bounding box element.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-box-success-fr" xml:lang="fr">L'étendue contient une emprise géographique.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-poly-success-en" xml:lang="en">The extent contains a bounding polygon.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-poly-success-fr" xml:lang="fr">L'étendue contient un polygone englobant.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-vertical-success-en" xml:lang="en">The extent contains a vertical element.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-vertical-success-fr" xml:lang="fr">L'étendue contient une étendue verticale.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.extenthasoneelement-temporal-success-en" xml:lang="en">The extent contains a temporal element.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.extenthasoneelement-temporal-success-fr" xml:lang="fr">L'étendue contient une étendue temporelle.</sch:diagnostic>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.gex.verticalhascrsorcrsid-failure-en" xml:lang="en">The vertical extent does not contains CRS or CRS identifier.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.verticalhascrsorcrsid-failure-fr" xml:lang="fr">L'étendue verticale ne contient pas de CRS ou d'identifiant de CRS.</sch:diagnostic>
    
      <sch:diagnostic id="rule.gex.verticalhascrsorcrsid-success-en" xml:lang="en">The vertical extent contains CRS information.</sch:diagnostic>
      <sch:diagnostic id="rule.gex.verticalhascrsorcrsid-success-fr" xml:lang="fr">L'étendue verticale contient les informations sur le CRS.</sch:diagnostic>
  </sch:diagnostics>
   ...
   <sch:diagnostics>
      ...
      <sch:diagnostic id="rule.mco-releasability-statement-success-en" xml:lang="en">
      The releasability statement is
      "<sch:value-of select="normalize-space($statement)"/>".
    </sch:diagnostic>
      <sch:diagnostic id="rule.mco-releasability-statement-success-fr" xml:lang="fr">
   ...
   <sch:pattern id="rule.mco-releasability">
    ...
    specified an addresse or a statement</sch:title>
      ...
      <sch:rule context="//mco:MD_Releasability">
         ...
         <sch:let name="addressee" value="mco:addressee[normalize-space(.) != '']"/>
      
         <sch:let name="statement" value="mco:statement/*[normalize-space(.) != '']"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mco-legalconstraintdetails-failure-en" xml:lang="en">
      The legal constraint is incomplete.</sch:diagnostic>
      <sch:diagnostic id="rule.mco-legalconstraintdetails-failure-fr" xml:lang="fr">
      La contrainte légale est incomplète.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mco-legalconstraintdetails-success-en" xml:lang="en">
      The legal constraint is complete.
    </sch:diagnostic>
      <sch:diagnostic id="rule.mco-legalconstraintdetails-success-fr" xml:lang="fr">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mco-legalconstraint-other-failure-en" xml:lang="en">
      ...
      <sch:diagnostic id="rule.mco-legalconstraint-other-failure-fr" xml:lang="fr">
      ...
      <sch:diagnostic id="rule.mco-legalconstraint-other-success-en" xml:lang="en">
      The legal constraint other constraints is 
      "<sch:value-of select="$otherConstraints"/>".
    </sch:diagnostic>
      <sch:diagnostic id="rule.mco-legalconstraint-other-success-fr" xml:lang="fr">
   ...
   <sch:pattern id="rule.mco-legalconstraint-other">
      ...
      <sch:rule context="//mco:MD_LegalConstraints[       mco:accessConstraints/mco:MD_RestrictionCode/@codeListValue = 'otherRestrictions' or       mco:useConstraints/mco:MD_RestrictionCode/@codeListValue = 'otherRestrictions'       ]">
      
      
         <sch:let name="otherConstraints"
                  value="mco:otherConstraints/*[normalize-space(.) != '']"/>
      
         <sch:let name="hasOtherConstraints" value="count($otherConstraints) &gt; 0"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mdb.root-element-failure-en" xml:lang="en">The root element must be MD_Metadata.</sch:diagnostic>
      <sch:diagnostic id="rule.mdb.root-element-failure-fr" xml:lang="fr">Modifier l'élément racine du document pour que ce 
      soit un élément MD_Metadata.</sch:diagnostic>

      <sch:diagnostic id="rule.mdb.root-element-success-en" xml:lang="en">Root element MD_Metadata found.</sch:diagnostic>
      <sch:diagnostic id="rule.mdb.root-element-success-fr" xml:lang="fr">Élément racine MD_Metadata défini.</sch:diagnostic>
  </sch:diagnostics>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mdb.defaultlocale-failure-en" xml:lang="en">The default locale character encoding is "UTF-8". Current value is
      "<sch:value-of select="$encoding"/>".</sch:diagnostic>
      <sch:diagnostic id="rule.mdb.defaultlocale-failure-fr" xml:lang="fr">L'encodage ne doit pas être vide. La valeur par défaut est 
      "UTF-8". La valeur actuelle est "<sch:value-of select="$encoding"/>".</sch:diagnostic>
    
    
      <sch:diagnostic id="rule.mdb.defaultlocale-success-en" xml:lang="en">The characeter encoding is "<sch:value-of select="$encoding"/>.
    </sch:diagnostic>
      <sch:diagnostic id="rule.mdb.defaultlocale-success-fr" xml:lang="fr">L'encodage est "<sch:value-of select="$encoding"/>.
    </sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.mdb.defaultlocale">
      ...
      <sch:rule context="/mdb:MD_Metadata/mdb:defaultLocale|                        /mdb:MD_Metadata/mdb:identificationInfo/*/mri:defaultLocale">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mdb.scope-name-failure-en" xml:lang="en">Specify a name for the metadata scope 
      (required if the scope code is not "dataset", in that case
      "<sch:value-of select="$scopeCode"/>").</sch:diagnostic>
      <sch:diagnostic id="rule.mdb.scope-name-failure-fr" xml:lang="fr">Préciser la description du domaine d'application 
      ...
      <sch:diagnostic id="rule.mdb.scope-name-success-fr" xml:lang="fr">La description du domaine d'application 
      "<sch:value-of select="$scopeCodeName"/>
         <sch:value-of select="$nilReason"/>"
   ...
   <sch:pattern id="rule.mdb.scope-name">
      ...
      <sch:rule context="/mdb:MD_Metadata/mdb:metadataScope/                           mdb:MD_MetadataScope[not(mdb:resourceScope/                             mcc:MD_ScopeCode/@codeListValue = 'dataset')]">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mdb.create-date-failure-en" xml:lang="en">Specify a creation date for the metadata record 
      in the metadata section.</sch:diagnostic>
      <sch:diagnostic id="rule.mdb.create-date-failure-fr" xml:lang="fr">Définir une date de création pour le document
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mex.datatypedetails-maxocc-failure-en" xml:lang="en">
      ...
      <sch:diagnostic id="rule.mex.datatypedetails-maxocc-failure-fr" xml:lang="fr">
      ...
      <sch:diagnostic id="rule.mex.datatypedetails-maxocc-success-en" xml:lang="en">
      Extended element information "<sch:value-of select="$name"/>"
      of type "<sch:value-of select="$dataType"/>"
      has max occurence: "<sch:value-of select="$maximumOccurrence"/>".
    </sch:diagnostic>
      <sch:diagnostic id="rule.mex.datatypedetails-maxocc-success-fr" xml:lang="fr">
      L'élément d'extension "<sch:value-of select="$name"/>"
      de type "<sch:value-of select="$dataType"/>"
      ...
      <sch:diagnostic id="rule.mex.datatypedetails-domain-failure-en" xml:lang="en">
      Extended element information "<sch:value-of select="$name"/>"
      of type "<sch:value-of select="$dataType"/>"
      does not specified domain value.</sch:diagnostic>
      <sch:diagnostic id="rule.mex.datatypedetails-domain-failure-fr" xml:lang="fr">
      L'élément d'extension "<sch:value-of select="$name"/>"
      de type "<sch:value-of select="$dataType"/>"
      ne précise pas la valeur du domaine.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mex.datatypedetails-domain-success-en" xml:lang="en">
      Extended element information "<sch:value-of select="$name"/>"
      of type "<sch:value-of select="$dataType"/>"
      has domain value: "<sch:value-of select="$domainValue"/>".
    </sch:diagnostic>
      <sch:diagnostic id="rule.mex.datatypedetails-domain-success-fr" xml:lang="fr">
      L'élément d'extension "<sch:value-of select="$name"/>"
      de type "<sch:value-of select="$dataType"/>"
   ...
   <sch:pattern id="rule.mex.datatypedetails">
      ...
      <sch:rule context="//mex:MD_ExtendedElementInformation[       mex:dataType/mex:MD_DatatypeCode/@codeListValue != 'codelist' and       mex:dataType/mex:MD_DatatypeCode/@codeListValue != 'enumeration' and       mex:dataType/mex:MD_DatatypeCode/@codeListValue != 'codelistElement'       ]">
   ...
   <sch:pattern id="rule.mex.conditional">
      ...
      <sch:rule context="//mex:MD_ExtendedElementInformation[       mex:obligation/mex:MD_ObligationCode = 'conditional'       ]">
   ...
   <sch:diagnostics>
      ...
      <sch:diagnostic id="rule.mex.mex.mandatoryconceptname-failure-en" xml:lang="en">
      The extended element "<sch:value-of select="$name"/>"
      of type "<sch:value-of select="$dataType"/>"
      does not specified a concept name.</sch:diagnostic>
      <sch:diagnostic id="rule.mex.mex.mandatoryconceptname-failure-fr" xml:lang="fr">
      L'élément d'extension "<sch:value-of select="$name"/>"
      de type "<sch:value-of select="$dataType"/>"
      ne précise pas de nom de concept.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mex.mex.mandatoryconceptname-success-en" xml:lang="en">
      The extended element "<sch:value-of select="$name"/>"
      of type "<sch:value-of select="$dataType"/>"
      has for concept name: "<sch:value-of select="$conceptName"/>".
    </sch:diagnostic>
      <sch:diagnostic id="rule.mex.mex.mandatoryconceptname-success-fr" xml:lang="fr">
      L'élément d'extension "<sch:value-of select="$name"/>"
      de type "<sch:value-of select="$dataType"/>"
   ...
   <sch:pattern id="rule.mex.mandatorycode">
      ...
      <sch:rule context="//mex:MD_ExtendedElementInformation[       mex:dataType/mex:MD_DatatypeCode/@codeListValue = 'codelist' or       mex:dataType/mex:MD_DatatypeCode/@codeListValue = 'enumeration' or       mex:dataType/mex:MD_DatatypeCode/@codeListValue = 'codelistElement'       ]">
    ...
    specified an update frequency</sch:title>
      ...
      <sch:rule context="//mmi:MD_MaintenanceInformation">
         ...
         <sch:let name="userDefinedMaintenanceFrequency"
                  value="mmi:userDefinedMaintenanceFrequency/                 gmw:TM_PeriodDuration[normalize-space(.) != '']"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mrc.sampledimension-failure-en" xml:lang="en">The sample dimension does not provide max, min or mean value.</sch:diagnostic>
      <sch:diagnostic id="rule.mrc.sampledimension-failure-fr" xml:lang="fr">La dimension ne précise pas de valeur maximum ou minimum ni de moyenne.</sch:diagnostic>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mrc.bandunit-failure-en" xml:lang="en">The band defined a bound without unit.</sch:diagnostic>
      <sch:diagnostic id="rule.mrc.bandunit-failure-fr" xml:lang="fr">La bande définit une borne minimum et/ou maximum
   ...
   <sch:pattern id="rule.mrc.bandunit">
      ...
      <sch:rule context="//mrc:MD_Band[       normalize-space(mrc:boundMax/*) != '' or        normalize-space(mrc:boundMin/*) != ''       ]">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mrd.mediumunit-failure-en" xml:lang="en">The medium define a density without unit.</sch:diagnostic>
      <sch:diagnostic id="rule.mrd.mediumunit-failure-fr" xml:lang="fr">La densité du média est définie sans unité.</sch:diagnostic>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mri.datasetextent-failure-en" xml:lang="en">The dataset MUST provide a 
      geographic description or a bounding box.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.datasetextent-failure-fr" xml:lang="fr">Le jeu de données DOIT être décrit par
      une description géographique ou une emprise.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mri.datasetextentdesc-success-en" xml:lang="en">The dataset geographic description is:
      "<sch:value-of select="normalize-space($geodescription)"/>".</sch:diagnostic>
      <sch:diagnostic id="rule.mri.datasetextentdesc-success-fr" xml:lang="fr">La description géographique du jeu de données est
      "<sch:value-of select="normalize-space($geodescription)"/>".</sch:diagnostic>
    
    
      <sch:diagnostic id="rule.mri.datasetextentbox-success-en" xml:lang="en">The dataset geographic bounding box is:
      ...
      .</sch:diagnostic>
      <sch:diagnostic id="rule.mri.datasetextentbox-success-fr" xml:lang="fr">L'emprise géographique du jeu de données est
      [W:<sch:value-of select="$geobox/gex:westBoundLongitude/*/text()"/>,
      S:<sch:value-of select="$geobox/gex:southBoundLatitude/*/text()"/>],
      [E:<sch:value-of select="$geobox/gex:eastBoundLongitude/*/text()"/>,
      N:<sch:value-of select="$geobox/gex:northBoundLatitude/*/text()"/>]
   ...
   <sch:pattern id="rule.mri.datasetextent">
      ...
      <sch:rule context="/mdb:MD_Metadata[mdb:metadataScope/                           mdb:MD_MetadataScope/mdb:resourceScope/                           mcc:MD_ScopeCode/@codeListValue = 'dataset']/                           mdb:identificationInfo/mri:MD_DataIdentification">
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mri.topicategoryfordsandseries-failure-en" xml:lang="en">A topic category MUST be specified for 
      dataset or series.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.topicategoryfordsandseries-failure-fr" xml:lang="fr">Un thème principal (ISO) DOIT être défini quand
      la ressource est un jeu de donnée ou une série.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mri.topicategoryfordsandseries-success-en" xml:lang="en">Number of topic category identified: 
      <sch:value-of select="count($topics)"/>.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.topicategoryfordsandseries-success-fr" xml:lang="fr">Nombre de thèmes : 
      <sch:value-of select="count($topics)"/>.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.mri.topicategoryfordsandseries">
      ...
      <sch:rule context="/mdb:MD_Metadata[mdb:metadataScope/                          mdb:MD_MetadataScope/mdb:resourceScope/                          mcc:MD_ScopeCode/@codeListValue = 'dataset' or                           mdb:metadataScope/                          mdb:MD_MetadataScope/mdb:resourceScope/                          mcc:MD_ScopeCode/@codeListValue = 'series']/                          mdb:identificationInfo/mri:MD_DataIdentification">
      
      <!-- The topic category is the enumeration value and
      not the human readable one. -->
         <sch:let name="topics" value="mri:topicCategory/mri:MD_TopicCategoryCode"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mri.associatedresource-failure-en" xml:lang="en">When a resource is associated, a name or a metadata
      reference MUST be specified.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.associatedresource-failure-fr" xml:lang="fr">Lorsqu'une resource est associée, un nom ou une 
      référence à une fiche DOIT être défini.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mri.associatedresource-success-en" xml:lang="en">The resource "<sch:value-of select="$resourceRef"/>"
      is associated.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.associatedresource-success-fr" xml:lang="fr">La ressource "<sch:value-of select="$resourceRef"/>" 
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mri.defaultlocalewhenhastext-failure-en" xml:lang="en">Resource language MUST be defined when the resource
      includes textual information.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.defaultlocalewhenhastext-failure-fr" xml:lang="fr">La langue de la resource DOIT être renseignée
      lorsque la ressource contient des informations textuelles.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mri.defaultlocalewhenhastext-success-en" xml:lang="en">Number of resource language: 
      <sch:value-of select="count($resourceLanguages)"/>.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.defaultlocalewhenhastext-success-fr" xml:lang="fr">Nombre de langues de la ressource :
      <sch:value-of select="count($resourceLanguages)"/>.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.mri.defaultlocalewhenhastext">
    ...
    -->
      <sch:rule context="//mri:MD_DataIdentification[       ../../mdb:contentInfo/mrc:MD_FeatureCatalogue or       ../../mdb:contentInfo/mrc:MD_FeatureCatalogueDescription]">
      
         <sch:let name="resourceLanguages"
                  value="mri:defaultLocale/lan:PT_Locale/                 lan:language/lan:LanguageCode/@codeListValue[. != '']"/>
         <sch:let name="hasAtLeastOneLanguage" value="count($resourceLanguages) &gt; 0"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.mri.servicetaxonomy-failure-en" xml:lang="en">A service metadata SHALL refer to the service
      taxonomy defined in ISO19119 defining one or more value in the
      keyword section.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.servicetaxonomy-failure-fr" xml:lang="fr">Une métadonnée de service DEVRAIT référencer
      un type de service tel que défini dans l'ISO19119 dans la
      section mot clé.</sch:diagnostic>
    
      <sch:diagnostic id="rule.mri.servicetaxonomy-success-en" xml:lang="en">Number of service taxonomy specified: 
      <sch:value-of select="count($serviceTaxonomies)"/>.</sch:diagnostic>
      <sch:diagnostic id="rule.mri.servicetaxonomy-success-fr" xml:lang="fr">Nombre de types de service :
      <sch:value-of select="count($serviceTaxonomies)"/>.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.srv.servicetaxonomy">
    ...
    -->
      <sch:rule context="//srv:SV_ServiceIdentification">
         ...
         <sch:let name="hasAtLeastOneTaxonomy" value="count($serviceTaxonomies) &gt; 0"/>
   ...
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.chainoroperations-failure-en" xml:lang="en">The service identification does not contain chain or operation.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.chainoroperations-failure-fr" xml:lang="fr">L'identification du service ne contient ni chaîne d'opérations, ni opération.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.chainoroperations-success-en" xml:lang="en">
      ...
      <sch:diagnostic id="rule.srv.chainoroperations-success-fr" xml:lang="fr">
   ...
   <sch:pattern id="rule.srv.chainoroperations">
      ...
      having a name. -->
         <sch:let name="chains"
                  value="srv:containsChain[         normalize-space(srv:SV_OperationChainMetadata/srv:name) != '']"/>
         <sch:let name="operations"
                  value="srv:containsOperations[         normalize-space(srv:SV_OperationMetadata/srv:operationName) != '']"/>
         <sch:let name="hasChainOrOperation"
                  value="count($operations) + count($chains) &gt; 0"/>
      
         <sch:assert test="$hasChainOrOperation"
                     diagnostics="rule.srv.chainoroperations-failure-en                       rule.srv.chainoroperations-failure-fr"/>
      
         <sch:report test="$hasChainOrOperation"
                     diagnostics="rule.srv.chainoroperations-success-en                       rule.srv.chainoroperations-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.coupledresource-failure-en" xml:lang="en">The service identification MUST specified coupling type 
      when coupled resource exist</sch:diagnostic>
      <sch:diagnostic id="rule.srv.coupledresource-failure-fr" xml:lang="fr">L'identification du service DOIT 
      définir un type de couplage lorsqu'une ressource est couplée.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.coupledresource-success-en" xml:lang="en">
      ...
      <sch:diagnostic id="rule.srv.coupledresource-success-fr" xml:lang="fr">
   ...
   <sch:pattern id="rule.srv.coupledresource">
      ...
      <sch:rule context="//srv:SV_ServiceIdentification[srv:coupledResource]">
         ...
         <sch:let name="couplingType"
                  value="srv:couplingType/                         srv:SV_CouplingType/@codeListValue[. != '']"/>
         <sch:let name="coupledResource" value="srv:coupledResource"/>
         <sch:let name="hasCouplingType" value="count($couplingType) &gt; 0"/>
      
         <sch:assert test="$hasCouplingType"
                     diagnostics="rule.srv.coupledresource-failure-en                       rule.srv.coupledresource-failure-fr"/>
      
         <sch:report test="$hasCouplingType"
                     diagnostics="rule.srv.coupledresource-success-en                       rule.srv.coupledresource-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.operateddataset-failure-en" xml:lang="en">The service identification define operatedDataset.
      No operatesOn can be specified.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.operateddataset-failure-fr" xml:lang="fr">L'identification du service utilise operatedDataset.
      OperatesOn ne peut être utilisé dans ce cas.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.operateddataset-success-en" xml:lang="en">Service identification only use operated dataset.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.operateddataset-success-fr" xml:lang="fr">L'identification du service n'utilise que operatedDataset.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.srv.operateddataset">
      ...
      <sch:rule context="//srv:SV_ServiceIdentification[srv:operatedDataset]">
         ...
         <sch:let name="hasOperatesOn" value="count($operatesOn) &gt; 0"/>
      
         <sch:assert test="not($hasOperatesOn)"
                     diagnostics="rule.srv.operateddataset-failure-en                       rule.srv.operateddataset-failure-fr"/>
      
         <sch:report test="not($hasOperatesOn)"
                     diagnostics="rule.srv.operateddataset-success-en                       rule.srv.operateddataset-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.operatesononly-failure-en" xml:lang="en">The service identification define operatesOn.
      No operatedDataset can be specified.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.operatesononly-failure-fr" xml:lang="fr">L'identification du service utilise operatesOn.
      OperatedDataset ne peut être utilisé dans ce cas.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.operatesononly-success-en" xml:lang="en">The service identification only use operates on.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.operatesononly-success-fr" xml:lang="fr">L'identification du service n'utilise que 
   ...
   <sch:pattern id="rule.srv.operatesononly">
      ...
      <sch:rule context="//srv:SV_ServiceIdentification[srv:operatesOn]">
         ...
         <sch:let name="hasOperatedDataset" value="count($operatedDataset) &gt; 0"/>
      
         <sch:assert test="not($hasOperatedDataset)"
                     diagnostics="rule.srv.operatesononly-failure-en                       rule.srv.operatesononly-failure-fr"/>
      
         <sch:report test="not($hasOperatedDataset)"
                     diagnostics="rule.srv.operatesononly-success-en                       rule.srv.operatesononly-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.harresourcereforresource-failure-en" xml:lang="en">The coupled resource does not contains a resource 
    nor a resource reference.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.harresourcereforresource-failure-fr" xml:lang="fr">La ressource couplée ne contient ni une ressource
    ni une référence à une ressource.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.harresourcereforresource-success-en" xml:lang="en">The coupled resource contains a resource or a resource reference.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.harresourcereforresource-success-fr" xml:lang="fr">La ressource couplée contient une ressource ou une référence 
   ...
   <sch:pattern id="rule.srv.harresourcereforresource">
      ...
      <sch:rule context="//srv:SV_CoupledResource">
         ...
         <sch:assert test="$hasResourceReferenceOrResource"
                     diagnostics="rule.srv.harresourcereforresource-failure-en                       rule.srv.harresourcereforresource-failure-fr"/>
      
         <sch:report test="$hasResourceReferenceOrResource"
                     diagnostics="rule.srv.harresourcereforresource-success-en                       rule.srv.harresourcereforresource-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresource-failure-en" xml:lang="en">The coupled resource contains both a resource 
      and a resource reference.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresource-failure-fr" xml:lang="fr">La ressource couplée utilise à la fois une ressource
      et une référence à une ressource.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.coupledresourceonlyresource-success-en" xml:lang="en">The coupled resource contains only resources.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresource-success-fr" xml:lang="fr">La ressource couplée contient uniquement des ressources.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.srv.coupledresourceonlyresource">
      ...
      <sch:rule context="//srv:SV_CoupledResource[srv:resource]">
         ...
         <sch:let name="resourceReference" value="srv:resourceReference"/>
         <sch:let name="hasResourceReference" value="count($resourceReference) &gt; 0"/>
      
         <sch:assert test="not($hasResourceReference)"
                     diagnostics="rule.srv.coupledresourceonlyresource-failure-en                       rule.srv.coupledresourceonlyresource-failure-fr"/>
      
         <sch:report test="not($hasResourceReference)"
                     diagnostics="rule.srv.coupledresourceonlyresource-success-en                       rule.srv.coupledresourceonlyresource-success-fr"/>
      </sch:rule>
  </sch:pattern>
   <sch:diagnostics>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresourceref-failure-en" xml:lang="en">The coupled resource contains both a resource 
      and a resource reference.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresourceref-failure-fr" xml:lang="fr">La ressource couplée utilise à la fois une ressource
      et une référence à une ressource.</sch:diagnostic>
    
      <sch:diagnostic id="rule.srv.coupledresourceonlyresourceref-success-en" xml:lang="en">The coupled resource contains only resource references.</sch:diagnostic>
      <sch:diagnostic id="rule.srv.coupledresourceonlyresourceref-success-fr" xml:lang="fr">La ressource couplée contient uniquement des références à des ressources.</sch:diagnostic>
  </sch:diagnostics>
   <sch:pattern id="rule.srv.coupledresourceonlyresourceref">
      ...
      <sch:rule context="//srv:SV_CoupledResource[srv:resourceReference]">
         ...
         <sch:let name="resource" value="srv:resource"/>
         <sch:let name="hasResource" value="count($resource) &gt; 0"/>
      
         <sch:assert test="not($hasResource)"
                     diagnostics="rule.srv.coupledresourceonlyresourceref-failure-en                       rule.srv.coupledresourceonlyresourceref-failure-fr"/>
      
         <sch:report test="not($hasResource)"
                     diagnostics="rule.srv.coupledresourceonlyresourceref-success-en                       rule.srv.coupledresourceonlyresourceref-success-fr"/>
      </sch:rule>
  </sch:pattern>
</sch:schema>