...
<xsl:template match="//mds:MD_Metadata|//*[@gco:isoType='mds:MD_Metadata']" priority="1000"
      ...
      <xsl:variable name="language"
                    select="mds:defaultLocale/lan:PT_Locale/lan:language/lan:LanguageCode/@codeListValue"/>
      <xsl:variable name="localeAndNoLanguage"
                    select="not(mds:defaultLocale and mds:defaultLocale/lan:PT_Locale/lan:language/@gco:nilReason='missing')                 and not(mds:defaultLocale and not(mds:defaultLocale/lan:PT_Locale/lan:language))"/>
      <xsl:variable name="duplicateLanguage"
                    select="not(mds:defaultLocale/lan:PT_Locale/lan:language/lan:LanguageCode/@codeListValue=$language)"/>
