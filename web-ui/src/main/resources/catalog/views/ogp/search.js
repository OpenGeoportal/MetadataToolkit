/**
 * Created by JuanLuis on 30/03/2015.
 */
(function() {
  goog.provide('gn_search_ogp');

  goog.require('cookie_warning');
  goog.require('gn_mdactions_directive');
  goog.require('gn_related_directive');
  goog.require('gn_search');
  goog.require('gn_search_ogp_config');
  goog.require('gn_search_default_directive');

  var module = angular.module('gn_search_ogp', ['gn_search', 'gn_search_ogp_config',
   ...
   *
   * @description
   * OGP view root controller
   * its $scope inherits from gnSearchController scope.
   *
   */
  module.controller('gnsOgp', [
    '$scope',
    '$location',
    'suggestService',
    '$http',
